...
def inicalizaTriangulo():
    ...
    points = [
		...
		-0.5, 0.5, 0.0, #cima (x, y, z)
		0.0, -0.5, 0.0, #direita
		-1.0, -0.5, 0.0, #esquerda
        #triangulo retangulo
        0.25, 0.25, 0.0, #esquerda/baixo
        0.25, 0.75, 0.0, #cima
        0.75, 0.25, 0.0, #direita/baixo
        #quadrado - triangulo esquerda/baixo
        0.25, -0.5, 0.0, #esquerda/baixo
        0.25, 0.0, 0.0, #cima
        0.75, -0.5, 0.0, #direita/baixo
        #quadrado - triangulo direita/cima
        0.25, 0.0, 0.0, #cima/esquerda
        0.75, 0.0, 0.0, #cima/direita    
        0.75, -0.5, 0.0, #direita/baixo
    ...
    cores = [
        #cores do triângulo equilátero
		1.0, 0.0, 0.0, #vermelho RGB
		0.0, 1.0, 0.0, #verde RGB
		0.0, 0.0, 1.0,  #azul RGB
        #cores do triângulo retângulo
        1.0, 0.0, 0.0, #vermelho RGB
        1.0, 0.0, 0.0, #vermelho RGB
        1.0, 0.0, 0.0,  #vermelho RGB
        #quadrado - triangulo esquerda/baixo
    ...
    glEnableVertexAttribArray(1) #Esse VBO é o segundo parâmetro do objeto, ou seja, índice 1
...
def inicializaShaders():
    ...
    vertex_shader = """
        ...
        layout(location = 1) in vec3 vertex_cores; //vem do python
        out vec3 cores; //sai do vertex shader e vai pro fragment shader
        void main () {
            cores = vertex_cores;
    ...
    fragment_shader = """
        #version 400
        in vec3 cores;//vem do vertex shader
...
def inicializaRenderizacao():
    ...
    while not glfw.window_should_close(Window):
        ...
        # Desenhamos o triângulo equilátero e o triângulo retângulo especificados no vao
