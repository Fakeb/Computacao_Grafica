...
def inicializaShaders():
    ...
    vertex_shader = """
        ...
        out vec3 posicao_cor; //vai ser passada para o fragment shader
        void main () {
            posicao_cor = vertex_posicao;
    ...
    fragment_shader = """
        #version 400
        in vec3 posicao_cor; //variavel recebida do vertex shader
		out vec4 frag_colour; //sai do fragment shader e vai para a tela do computador (RGBA)
		void main () {
		    frag_colour = vec4 (posicao_cor, 1.0);
		}
    """
