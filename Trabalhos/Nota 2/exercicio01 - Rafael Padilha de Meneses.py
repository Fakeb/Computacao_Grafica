...
def inicializaObjetos():
    ...
    points = [
		...
		0.5, -0.05, 0.0, #cima (x, y, z)
		0.95, -0.95, 0.0, #direita
		0.05, -0.95, 0.0, #esquerda

        #triangulo retangulo
        -0.95, -0.05, 0.0, #cima (x, y, z)
		-0.05, -0.95, 0.0, #direita
		-0.95, -0.95, 0.0, #esquerda

        #quadrado feito com um triangulo retangulo
        -0.40, 0.95, 0.0, #cima (x, y, z)
		0.40, 0.25, 0.0, #direita
		-0.40, 0.25, 0.0, #esquerda
        
        #quadrado feito com um triangulo retangulo
        -0.40, 0.95, 0.0, #cima (x, y, z)
		0.40, 0.25, 0.0, #direita
		0.40, 0.95, 0.0, #esquerda
    ...
    cores = [
        ...
        #triangulo retangulo roxo
        0.60, 0.20, 0.75, #vermelho RGB
		0.60, 0.20, 0.75, #verde RGB
		0.60, 0.20, 0.75,  #azul RGB

        #quadrado roxo
        0.4, 0.8, 0.25, #vermelho RGB
		0.4, 0.8, 0.25, #verde RGB
		0.4, 0.8, 0.25,  #azul RGB
